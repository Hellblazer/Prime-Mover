 ...
 * 1. Scans classpath for @Entity annotated classes
 * 2. Identifies event methods (from interfaces or @Event annotations)
 * 3. Generates simulation-aware bytecode using EntityGeneratorRefactored
 * 4. Handles API remapping (Kronos -> Kairos) for transformed classes
 * 
