...
/**
 * Helper class for the subject interface to make the administration code
 * reusable
 *
...
public class SubjectAdministration<T, X> {
     ...
     */
    private final List<Observer<T, X>> observers = new ArrayList<>();
    ...
    /**
     * Notifies all registered observers and passes a reference of the subject and a
     * eventtype to the observer
     *
     * @param subject     the reference of the actual subject
     * @param eventObject the event type of the notify call. This is optional to
     *                    distinguish the events and can be null
     */
