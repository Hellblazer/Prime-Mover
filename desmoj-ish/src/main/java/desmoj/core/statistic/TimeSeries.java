 ...
 * SimClock. See the automatic parameter in the constructor. If writing to a file is claimed, the first line of the file
 * contains the name of the file. Then each line of the file contains a SimTime value and the value of the
 * <code>ValueSupplier</code> object at that point of time in the simulation,
 * separated by a ";". <br> One can choose when the recording of the values will start and stop. See the constructor for
 * further information. <br> Reseting the <code>TimeSeries</code> object will delete the contents of the file. <br> This
 * <code>TimeSeries</code> object will be the observer of the
 * <code>ValueSupplier</code> object given in the constructor. When constructing
 * a new <code>TimeSeries</code> object it will be added to the list of observers of the <code>ValueSupplier</code>.
 * That means this
...
public class TimeSeries extends desmoj.core.statistic.StatisticObjectSupportingTimeSpans {
    ...
    public TimeSeries(Model ownerModel, String name, String fileName, TimeInstant start, TimeInstant end,
        ...
        if (fileName == null) {
            sendWarning(
            "Attempt to write to a file which has no name. " + "The file will be named: 'unnamed_TimeSeries_File'!",
     ...
     * not connect this object to a TimeSeriesPlotter after using this constructor, it will be useless. Choose another
     * constructor for writing data to file.
     *
     * @param ownerModel   Model : The model this TimeSeries object is associated to
     * @param name         java.lang.String : The name of this TimeSeries object
     * @param start        TimeInstant : The instant at which this TimeSeries will start to save the values to the
    ...
    public TimeSeries(Model ownerModel, String name, ValueSupplier valSup, TimeInstant start, TimeInstant end,
        ...
        if (valSup == null) {
            sendWarning(
            "Attempt to produce a TimeSeries about a non existing " + "ValueSupplier. The command will be ignored!",
            "TimeSeries: " + this.getName() + " Constructor: TimeSeries(Model "
            + "ownerModel, String name, String fileName, ValueSupplier valSup,"
            + " SimTime start, SimTime end, boolean automatic, boolean " + "showInTrace)",
     ...
     * object.
     *
     * @return double : The actual value of the observed <code>ValueSupplier</code> object.
     */
