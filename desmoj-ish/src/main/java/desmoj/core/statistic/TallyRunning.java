...
/**
 * The <code>TallyRunning</code> class is extended from <code>Tally</code>. Same
 * as <code>Tally</code>, it provides statistic analysis about one value (mean,
 * standard deviation, minimum, maximum). In addition, this class is able to
 * calculate this data based on the last <i>n</i> samples only, subject to
 * <i>n</i> passed to the constructor.
 *
 * @see Tally
...
public class TallyRunning extends desmoj.core.statistic.Tally {
     ...
     * @param n            int : Number of samples to include in running statistic
     *                     data.
     ...
     *                     Tally.
     */
    public TallyRunning(Model ownerModel, String name, int n, boolean showInReport, boolean showInTrace) {
        ...
        // n is less than 2
        if (n < 2) {
            sendWarning("Attempt to produce a TallyRunning based on the last n=" + +n
            + " samples. Sample size will be increased to 2!",
                        "TallyRunning: " + this.getName() + " Constructor: TallyRunning"
                        + " (Model ownerModel, String name, ValueSupplier valSup, "
                        + "int n, boolean showInReport, boolean showInTrace)", "The given sample size is too small.",
                        "Make sure to pass a sample size greater or equal to 2 to a new " + "TallyRunning object.");
     ...
     *                     Tally.
     */
    public TallyRunning(Model ownerModel, String name, ValueSupplier valSup, int n, boolean showInReport,
                        boolean showInTrace) {
    ...
    /**
     * Returns the mean value of the last <i>n</n> values observed. Note that if
     * less than n samples values are observed this far, the value returned will
     * only include fewer (i.e. all) samples.
     *
    ...
    /**
     * Returns the standard deviation of the last <i>n</n> values observed. Note
     * that if less than n samples values are observed this far, the value returned
     * will only include fewer (i.e. all) samples.
     *
     * @return double : The standard deviation of the last <i>n</n> values observed
     *         so far.
     */
     ...
     * <code>TallyRunning</code> will be updated with directly within the
     * <code>update(double val)</code> method instead of going via the
     * <code>ValueSupplier</code>.
     *
     * @param val double : The value with which this <code>TallyRunning</code> will
     *            be updated.
     */
    @Override
     ...
     * @param arg Object : The Object with which this <code>TallyRunning</code> is
     *            updated. Normally a double number which is added to the statistics
     *            or <code>null</code>.
     */
    @Override
    public void update(Observable o, Object arg) {
        ...
        {
            sendWarning("Attempt to update a TallyRunning with no reference to an "
            + "Observable. The actual value of '" + getValueSupplier().getName()
