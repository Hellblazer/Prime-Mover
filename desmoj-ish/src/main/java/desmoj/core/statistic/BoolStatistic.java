 ...
 * a boolean value. Statistics include <code>true</code>-ratio and total number
 * of observations.
 *
...
public class BoolStatistic extends desmoj.core.simulator.Reportable {
     ...
     * @param showInReport boolean : Flag for showing the report about BoolStatistic
     *                     Tally.
     * @param showInTrace  boolean : Flag for showing the trace output of
     *                     BoolStatistic Tally.
     */
    public BoolStatistic(Model ownerModel, String name, boolean showInReport, boolean showInTrace) {
     ...
     *
     * @return double : The ratio of <code>true</code>s per total observations so
     *         far.
     */
    public double getTrueRatio() {
        if (getObservations() == 0) {
            sendWarning("Attempt to get ratio of trues per total observations, but there is not "
            + "sufficient data yet. UNDEFINED (-1.0) will be returned!",
                        ...
                        "Make sure to ask for ratio of trues only after some data has been " + "collected already.");
        ...
        return StatisticObject.round(ratio);
    }

    /**
     * Resets this <code>BoolStatistic</code> object by deleting a observations this
     * far.
     */
    @Override
    public void reset() {
    ...
    /**
     * Updates this <code>BoolStatistic</code> object with a boolean double value
     * given as parameter.
     *
     * @param val boolean : The value with which this <code>BoolStatistic</code>
     *            will be updated.
     */
