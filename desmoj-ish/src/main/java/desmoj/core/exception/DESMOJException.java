 ...
 * <code>java.exception.RuntimeException</code> which has the special feature to
 * be re-thrown automatically by any method.
 *
...
public class DESMOJException extends RuntimeException {
     ...
     * properly describe what error occurred, where it occurred, what reasons could
     * be responsible for it and what could be done to prevent this error from
     * occurring.
     *
     * @param message desmoj.report.ErrorMessage : Describes the error leading to
     *                this exception
     */
     ...
     * exception being thrown. Use this method to extract the message and pass it to
     * the Experiment's MessageDistributor to write it to the ErrorFile.
     *
     * @return desmoj.report.ErrorMessage : The errormessage describing the reasons
     *         for this Exception
     */
