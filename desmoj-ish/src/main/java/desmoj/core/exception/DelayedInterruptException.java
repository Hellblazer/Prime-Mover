 ...
 * delayed interrupt. DelayedInterruptExceptions are used in with
 * {@link SimProcess#interruptDelayed(TimeInstant)} and
...
public class DelayedInterruptException extends InterruptException {
     ...
     *
     * @param interruptCode The InterruptCode to be contained within this
