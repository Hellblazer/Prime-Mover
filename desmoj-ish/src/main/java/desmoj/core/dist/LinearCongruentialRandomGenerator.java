 ...
 *
 */
public class LinearCongruentialRandomGenerator implements desmoj.core.dist.UniformRandomGenerator {
    ...
    /**
     * Creates a DefaultrandomGenerator with seed 42. The value 42 has been taken by
     * pure coincidence. It is not really related to Douglas Adams' "Hitchhikers
     * Guide to the Galaxy" trilogy of five books (so far).
     */
