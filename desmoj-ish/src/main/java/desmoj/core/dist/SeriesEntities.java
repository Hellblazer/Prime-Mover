 ...
 * from a list. This subclass of Series serves to sample entities. Series may be
 * used to simulate certain non-random scenarios within the simulation or to
 * include external sources of (preudo) random distributions
 * <p>
 *
...
public class SeriesEntities<E extends Entity> extends Series<E> {
     ...
     */
    public SeriesEntities(Model owner, String name, boolean showInReport, boolean showInTrace) {
