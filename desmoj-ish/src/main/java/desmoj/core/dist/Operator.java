...
public interface Operator {
    ...
    /**
     * Absolute difference operator, for arguments <code>a<code> and <code>b</code>
     * returning <code>|a-b|</code>.
     */
    ...
    /**
     * Should return a description of what the operator does to be shown by the
     * reporter. Example: "sum", "product" etc.
     *
    ...
    /**
     * This should return the desired of the result or the operation, depending on
     * the operands.
     *
     * @param operand1
     * @param operand2
