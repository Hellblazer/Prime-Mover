...
public abstract class DiscreteDist<N extends Number> extends NumericalDist<N> {
    ...
    /**
     * Constructs a distribution returning discretely distributed samples of a
     * custom type. Note that the method <code>N sample()</code> returning the
     * samples (inherited from <code>NumericalDist<N></code>) has to be implemented
     * in subclasses.
     *
