...
public class BoolDistBernoulli extends BoolDist {
     ...
     * return a "true" value. The given probability has to be in the range between 0
     * and 1. Higher values will be interpreted as 1 (always return "true").
     * Negative values are interpreted as 0 (always return "false").
     *
     * @param owner              Model : The distribution's owner
     * @param name               java.lang.String : The distribution's name
     * @param probabilityForTrue double : The probability for producing a
     *                           <code>true</code> sample
     * @param showInReport       boolean : Flag for producing reports
     * @param showInTrace        boolean : Flag for producing trace output
     */
    public BoolDistBernoulli(Model owner, String name, double probabilityForTrue, boolean showInReport,
                             boolean showInTrace) {
    ...
    /**
     * Returns the probability for <code>true</code> values. The value returned is
     ...
     * returned value will depend upon the seed of the underlying random generator
     * and the probability given for this distribution.
     *
