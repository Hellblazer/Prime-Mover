...
public class NameCatalog {
    ...
    /**
     * Stores the names of all Schedulables within an experiment. The names are used
     * as the indexing value via the string's method to produce a hashing key value.
     * The numbers for each individual name are stored as objects of their wrapper
     * class.
     */
    ...
    /**
     * Registers the given name in the namecatalog and returns the correct name with
     * the added number if necessary. If a <code>null</code> reference is given as
     * parameter, the returned name will be set to "unnamed" with the number of
