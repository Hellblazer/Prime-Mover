...

{
    ...
    public void insert(E e) {
        ...
        if (e == null) { // check for null reference
            sendWarning("Can not insert entity. Command ignored.", "Class: QueueListRandom Method: insert(Entity e).",
        ...
        // index between 0 (first) and size() (one position after the last Entity at
        // index size()-1)
