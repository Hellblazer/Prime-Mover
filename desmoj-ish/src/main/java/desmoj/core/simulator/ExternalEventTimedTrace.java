...
public class ExternalEventTimedTrace extends ExternalEvent {
     ...
     * and model.
     *
     * @param trueTime String : the true time value to be written into the trace
     *                 file
     * @param what     String : a short description of the true time value
     * @param owner    Model : the model this event shall belong to
     */
    public ExternalEventTimedTrace(String trueTime, int refUnit, String what, Model owner) {
    ...
    /**
     * Sends a trace note with the description and the true time including the time
     * unit.
     */
    @Override
