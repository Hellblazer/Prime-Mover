...
public class SimThread implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            new ErrorMessage(simProc.getModel(), "The simulation has been aborted due to an unhandled interrupt.",
            ...
            new ErrorMessage(simProc.getModel(), "The simulation has been aborted due to an unexpected exception.",
                             "SimProcess: " + simProc.getName() + " Method: void lifeCycle()",
                             "An exception occured: " + otherException, "Prevent the underlying exception.",
                             simProc.getModel().getExperiment().getSimClock().getTime()), otherException));
        }
