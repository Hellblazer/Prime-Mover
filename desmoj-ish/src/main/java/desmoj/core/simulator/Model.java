...
public abstract class Model extends Reportable {
     ...
     * <code>desmoj.report.ModelReporter</code> to extract and present that extra information.
     *
     ...
     * the experiment's <code>start()</code> method is called.
     */
     ...
     * @return List<Entity> : The class will return a list of all existing objects of <code>Entity</code>.
     */
     ...
     *
     * @return Entity : The class will return the <code>Entity</code> or null if no such exists.
     */
    ...
    /**
     * Returns the experiment that is connected to this model or <code>null</code> if the model is not yet connected to
     * an experiment.
     *
     ...
     * modelcomponents!</em> <br> This prevents the modelcomponents to get contact to the associated Experiment since a
     * Model can only be connected to an Experiment after itself has been instantiated correctly. Thus it is necessary
     * to put all initialization and instantiation work into this method. Do not use this method to do the initial
     ...
     * in the event-list, the scheduler will stop the simulation immediately because there is nothing for him to do. If
     * you are using submodels, take care that each of the submodels has its own <code>init</code> method properly set
     * up.
     */
     ...
     * <code>other</code> belongs to <code>this</code> model. For use with multiple models, the user has to specify
     * which other models are compatible to this model by overloading this method.
     *
     ...
     * <code>init()</code> method of all registered submodels of every submodel.
     */
    void doSubmodelInit() {
    ...
    /**
     * Sets the current model to be the main model by setting the <code>owner</code> reference to itself.
     */
    void setMain() {
