...
public class RealTimeEventWrapper {
    ...
    /**
     * A nanosecond timestamp that will be associated to the encapsulated
     * ExternalEvent.
     *
     */
    private long _nanos;
    ...
    /**
     * Creates an real time wrapper for an external event. This constructor will set
     * the nanosecond timestamp to the current value of System.nanoTime().
     *
     */
    ...
    /**
     * Returns the nanosecond timestamp associated with the encapsulated
     * ExternalEvent. *
     */
     ...
     * the nanosecond timestamp of this RealTimeEventWrapper.
     *
     */
    public void realTimeSchedule() {
        _myExternalEvent.getModel().getExperiment().getScheduler().realTimeSchedule(this);

    }

    /**
     * Sets the nanosecond timestamp of this RealTimeEventWrapper. Use method
     * System.nanoTime() to get a time stamp.
     */
