 ...
 * conditionally stopping an experiment. Override method check(E e) such that it returns <code>true</code> whenever the
 * model complies to the condition.
 *
 * @author Tim Lechler
 *
...
public abstract class ModelCondition extends ModelComponent {
     ...
     *                    should show up in trace, <code>false</code> if model should not be shown in trace.
    ...
    private Class<?> getType(Object obj) {
        ...
        return cls.equals(Boolean.class) ? Boolean.TYPE : cls.equals(Integer.class) ? Integer.TYPE : cls.equals(
        Character.class) ? Character.TYPE : cls.equals(Byte.class) ? Byte.TYPE : cls.equals(Short.class) ? Short.TYPE
                                                                                                         : cls.equals(
                                                                                                         Double.class)
                                                                                                           ? Double.TYPE
                                                                                                           : cls.equals(
