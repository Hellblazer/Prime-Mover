...
public class Resource extends ModelComponent {
    ...
    /**
     * Indicating if this resource is out of order (broken down) and therefore can
     ...
     * @param showInTrace boolean : Flag for showing this resource in trace files.
     *                    Set it to <code>true</code> if resource should show up in
     *                    trace. Set it to <code>false</code> if resource should not
     *                    be shown in trace.
     */
    public Resource(Model ownerModel, String name, Res resPool, boolean showInTrace) {
    ...
    /**
     * This resource can be set to out of order (<code>true</code>) if it is broken
     * down and can not be used at the moment.
     *
     * @param brokenDown boolean : Flag for showing if this resource is out of order
