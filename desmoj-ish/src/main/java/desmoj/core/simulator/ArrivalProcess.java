...
public abstract class ArrivalProcess<S extends SimProcess> extends SimProcess {
     ...
     * <code>SimProcess</code> es. So its lifeCycle is quite simple: Make a new
     * <code>SimProcess</code> object and activate it. Then wait until the next
     * <code>SimProcess</code> object is arriving at the system. Note: the first
     * <code>SimProcess</code> object is arriving when this
     * <code>ArrivalProcess</code> is started! This method uses the
     * <code>createSuccessor()</code> method to create a new <code>SimProcess</code>
     * object. If this method returns <code>null</code> the life cycle of this
     * <code>ArrivalProcess</code> will stop.
     */
    @Override
