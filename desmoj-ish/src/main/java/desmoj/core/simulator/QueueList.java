...
public abstract class QueueList<E extends Entity> implements PropertyChangeListener, Iterable<E> {
    ...
    public void setQueueBased(QueueBased queueBase) {
        ...
        if (queueBase == null) {
            ...
            new ErrorMessage(null, "Can not create QueueListStandardFifo! Simulation aborted.",
                             "Class : QueueListStandardFifo / Method : setClientQueue" + "(QueueBased queueBase) ",
                             "The reference to the QueueBased object needed is a null " + "reference.",
     ...
     * @return E : The <code>Entity</code> after the given <code>Entity</code> "e" in the queue.
     */
     ...
     * this was done successfully. Be careful with this operation. It might disrupt your order of priorities.
     *
     ...
     * @return E : The <code>Entity</code> before the given <code>Entity</code> "e" in the queue.
     */
    abstract E pred(E e);
     ...
     * the <code>QueueBased</code>'s flag for queue implementation warnings is set to <code>true</code>.
     *
