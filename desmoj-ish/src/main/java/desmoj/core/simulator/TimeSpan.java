...
public final class TimeSpan implements Comparable<TimeSpan> {
    ...
    /**
     * Use the Builder to create TimeSpans specified as the sum of durations with
     * different TimeUnits Example (timeSpan with the length of one hour and 30
     * minutes): new TimeSpan.Builder().hours(1).minutes(30).build();
     *
     */
    public static class Builder {
        ...
        public Builder days(long days) {
            ...
            durationInEpsilon += TimeOperations.getEpsilon().convert(days, DAYS);
            return this;
        }
        ...
        public Builder hours(long hours) {
            ...
            durationInEpsilon += TimeOperations.getEpsilon().convert(hours, HOURS);
            return this;
        }
        ...
        public Builder microseconds(long microseconds) {
            ...
            durationInEpsilon += TimeOperations.getEpsilon().convert(microseconds, MICROSECONDS);
            return this;
        }
        ...
        public Builder milliseconds(long milliseconds) {
            ...
            durationInEpsilon += TimeOperations.getEpsilon().convert(milliseconds, MILLISECONDS);
            return this;
        }
        ...
        public Builder minutes(long minutes) {
            ...
            durationInEpsilon += TimeOperations.getEpsilon().convert(minutes, MINUTES);
            return this;
        }
        ...
        public Builder nanoseconds(long nanoseconds) {
            ...
            durationInEpsilon += TimeOperations.getEpsilon().convert(nanoseconds, NANOSECONDS);
            return this;
        }
        ...
        public Builder seconds(long seconds) {
            ...
            durationInEpsilon += TimeOperations.getEpsilon().convert(seconds, SECONDS);
            return this;
        }
    }

    /**
     * Indicates whether TimeSpan a is equal to TimeSpan b, i.e. they are of equal
     * length.
     *
     ...
     * second. Note that this is a static method available through calling the class
     * <code>TimeSpan</code> i.e. <code>TimeSpan.isLonger(a,b)</code> where a and b
    ...
    /**
     * Checks if the first of two spans of simulation time is longer than the second
     * or equal to the second. Note that this is a static method available through
     * calling the class <code>TimeSpan</code> i.e.
     * <code>TimeSpan.isLonger(a,b)</code> where a and b are valid TimeSpan objects.
     *
     ...
     * second. Note that this is a static method available through calling the class
     * <code>TimeSpan</code> i.e. <code>TimeSpan.isShorter(a,b)</code> where a and b
     * are valid TimeSpan objects.
     *
    ...
    /**
     * Checks if the first of two spans of simulation time is shorter than the
     * second or equal to the second. Note that this is a static method available
     * through calling the class <code>TimeSpan</code> i.e.
     * <code>TimeSpan.isShorterOrEqual(a,b)</code> where a and b are valid TimeSpan
     * objects.
     *
    ...
    /**
     * Constructs a TimeSpan object with the given time value in the time unit of
     * the reference time. It represents a time span in simulation time. Note that
     * trying to create a TimeSpan object with a negative value will stop the
     ...
     *
     * @param duration double : The time value of this TimeSpan in the time unit of
     *                 the reference time.
     */
    ...
    /**
     * Constructs a TimeSpan object with the given time value in the given timeUnit.
     * It represents a time span in simulation time. Note that trying to create a
     * TimeSpan object with a negative value will stop the simulation immediately.
     * The simulation will also stop immediately if the TimeSpan is larger than
    ...
    public TimeSpan(double duration, TimeUnit unit) {
        ...
        if (_durationInEpsilon == Long.MAX_VALUE) {
            /*
             * The timeSpan is too big. (The method TimeUnit.convert(duration,unit)returns
             * Long.MAX_VALUE if the result of the conversion is to big
             */
     ...
     * TimeSpan is larger than Long.MAX_VALUE-1 (in the unit of epsilon).
     *
     * @param duration long : The time value of this TimeSpan in the time unit of
     *                 the reference time.
     */
    ...
    /**
     * Constructs a TimeSpan object with the given time value in the time unit of
     * the given parameter. It represents a time span in simulation time. Note that
     * trying to create a TimeSpan object with a negative value will stop the
     * simulation immediately. The simulation will also stop immediately if the
     * TimeSpan is larger than Long.MAX_VALUE-1 (in the unit of epsilon).
     *
     ...
     *         TimeSpan is shorter than, equal to, or longer than the given
     *         parameter.
     */
    @Override
    public int compareTo(TimeSpan anotherTimeSpan) {
        long difference = this.getTimeInEpsilon() - anotherTimeSpan.getTimeInEpsilon();
    ...
    /**
     * Indicates whether this TimeSpan is equal to the given parameter. Returns true
     * if the obj argument is a TimeSpan and is of equal length as this TimeSpan;
     * false otherwise. This method overrides java.lang.Object.equals()
     *
     * @param obj the reference object with which to compare.
     * @return true if the obj argument is a TimeSpan and is of equal length as this
    ...
    public double getTimeAsDouble(TimeUnit unit) {
        return _durationInEpsilon / (double) TimeOperations.getEpsilon().convert(1, unit);
    }

    /**
     * Returns the value of the TimeSpan object as a long type in the time unit of
     * epsilon
     *
    ...
    /**
     * Returns the value of this TimeSpan object as a long type in the time unit of
     * the reference time. If the parameter has a coarser granularity than epsilon
    ...
    public long getTimeRounded(TimeUnit unit) {
        if (unit.compareTo(TimeOperations.getEpsilon()) > 0) {
            ...
            long difference = _durationInEpsilon - TimeOperations.getEpsilon().convert(durationInUnitTruncated, unit);
