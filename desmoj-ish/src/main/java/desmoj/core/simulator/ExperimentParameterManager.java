...
/**
 * Interface to restrict the functionalities of a parameter-manager to manage experiment-parameters. This Interface
 * should be used as return-type of the Experiment's methods which return the parameter- manager.
 *
 * @author Tim Janz
 *
