...
public class ModelComponent extends NamedObject {
    ...
    public void sendDebugNote(String description) {
        ...
        if (currentlySendDebugNotes()) {
            sendMessage(new DebugNote(getModel(), presentTime(), getName(), description));
        }
    }
    ...
    public void sendMessage(Message m) {
        ...
        if (m == null) {
            sendWarning("Can't send Message!", "ModelComponent : " + getName() + " Method: SendMessage(Message m)",
    ...
    public void sendWarning(String description, String location, String reason, String prevention) {
        ...
        sendMessage(new ErrorMessage(getModel(), description, location, reason, prevention, presentTime()));
