...
public class DiscreteDistBinomialReporter extends DistributionReporter {
     ...
     *                          DiscreteDistBinomial distribution to report about
     */
    public DiscreteDistBinomialReporter(desmoj.core.simulator.Reportable informationSource) {
     ...
     *         about the DiscreteDistBinomial distribution
     */
    @Override
