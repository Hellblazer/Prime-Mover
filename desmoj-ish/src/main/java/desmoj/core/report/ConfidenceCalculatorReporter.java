...
public class ConfidenceCalculatorReporter extends desmoj.core.report.TallyReporter {

    // ****** methods ******

    /**
     * Constructor for a new ConfidenceCalculatorReporter. Note that although any
     * Reportable is accepted you should make sure that only subtypes of
     * ConfidenceCalculator are passed to this constructor. Otherwise the number of
     ...
     *                          ConfidenceCalculator to report about.
     */
    public ConfidenceCalculatorReporter(desmoj.core.simulator.Reportable informationSource) {
