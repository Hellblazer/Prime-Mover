...
public class BoolDistConstantReporter extends DistributionReporter {
     ...
     *                          BoolDistConstant distribution to report about
     */
    public BoolDistConstantReporter(desmoj.core.simulator.Reportable informationSource) {
     ...
     *         about the BoolDistConstant distribution
     */
    @Override
