...
/**
 * Captures all relevant information about the Count. Extended to show unit and
...
public class CountReporter extends desmoj.core.report.Reporter {
     ...
     * accepted you should make sure that only subtypes of Count are passed to this
     ...
     *
     * @param informationSource desmoj.core.simulator.Reportable : The Count to
     *                          report about
     */
