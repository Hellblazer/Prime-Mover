...
public interface AbstractChartData<N extends Number> {
    ...
    /**
     * Should return the data value at a given index. If the data doesn't exist,
     * <code>0</code> should be returned.
     *
     * @param index
    ...
    /**
     * Should return the highest data value. If there is no entry or the highest
     * data value is a negative number, 0 should be returned.
     *
     ...
     *
     * @return desmoj.core.simulator.Model : The model this chart data is associated
     *         to.
     */
    Model getOwnerModel();
     ...
     * Should return <code>true</code> if <code>this.getNumOfData()==0</code>, else
