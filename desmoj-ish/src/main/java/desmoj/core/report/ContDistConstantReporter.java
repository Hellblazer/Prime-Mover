...
public class ContDistConstantReporter extends DistributionReporter {
     ...
     *                          ContDistConstant to report about
     */
    public ContDistConstantReporter(desmoj.core.simulator.Reportable informationSource) {
     ...
     *         about the ContDistConstant distribution
     */
    @Override
