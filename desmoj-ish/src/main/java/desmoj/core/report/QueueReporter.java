...
public class QueueReporter extends Reporter {
    /**
     * Creates a QueueReporter. Note that although any Reportable is accepted you should make sure that only subtypes of
     * Queue are passed to this constructor. Otherwise the number of column titles and their individual headings will
