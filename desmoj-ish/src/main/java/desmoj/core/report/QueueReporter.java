...
public class QueueReporter extends Reporter {
    /**
     * Creates a QueueReporter. Note that although any Reportable is accepted you
     * should make sure that only subtypes of Queue are passed to this constructor.
     * Otherwise the number of column titles and their individual headings will
     * differ from the actual content collected by this reporter.
     *
     * @param informationSource desmoj.core.simulator.Reportable : The Queue to
     *                          report about
     */
     ...
     * column in array <code>columns[]</code>. Implement this method tha an array of
     * the same langth as the columntitles is produced containing the data at the
