...
public class DiscreteDistUniformReporter extends DistributionReporter {
     ...
     *                          DiscreteDistUniform distribution to report about
     */
    public DiscreteDistUniformReporter(desmoj.core.simulator.Reportable informationSource) {
     ...
     *         about the DiscreteDistUniform distribution
     */
    @Override
