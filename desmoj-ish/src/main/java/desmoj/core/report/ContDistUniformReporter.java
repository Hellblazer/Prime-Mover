...
public class ContDistUniformReporter extends DistributionReporter {
     ...
     *                          ContDistUniform distribution to report about
     */
    public ContDistUniformReporter(desmoj.core.simulator.Reportable informationSource) {
     ...
     *         about the ContDistUniform distribution
     */
    @Override
