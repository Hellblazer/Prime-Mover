...
public class ContDistBetaReporter extends DistributionReporter {
     ...
     *
     * @param informationSource desmoj.core.simulator.Reportable : The ContDistBeta
     *                          distribution to report about
     */
    public ContDistBetaReporter(desmoj.core.simulator.Reportable informationSource) {
    ...
    /**
     * Returns the array of strings containing all information about the BetaDist
     * distribution.
     *
     * @return java.lang.String[] : The array of Strings containing all information
     *         about the BetaDist distribution
     */
    @Override
