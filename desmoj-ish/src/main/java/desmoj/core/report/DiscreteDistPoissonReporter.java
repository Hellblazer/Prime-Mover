...
public class DiscreteDistPoissonReporter extends DistributionReporter {
     ...
     *
     * @param informationSource desmoj.core.simulator.Reportable : The discrete
     *                          Poisson distribution to report about
     */
    public DiscreteDistPoissonReporter(desmoj.core.simulator.Reportable informationSource) {
     ...
     *         about the DiscreteDistPoisson distribution
     */
    @Override
