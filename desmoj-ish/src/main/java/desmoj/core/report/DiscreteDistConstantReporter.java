...
public class DiscreteDistConstantReporter extends DistributionReporter {
     ...
     *                          DiscreteDistConstant to report about
     */
    public DiscreteDistConstantReporter(desmoj.core.simulator.Reportable informationSource) {
     ...
     *         about the DiscreteDistConstant distribution
     */
    @Override
