...
public class BoolDistBernoulliReporter extends DistributionReporter {
     ...
     *                          BoolDistBernoulli distribution to report about
     */
    public BoolDistBernoulliReporter(desmoj.core.simulator.Reportable informationSource) {
     ...
     *         about the BoolDistBernoulli distribution
     */
    @Override
