...
public class ProcessQueueReporter extends Reporter {
     ...
     * accepted you should make sure that only subtypes of Queue are passed to this
     ...
     *                          report about
     */
    public ProcessQueueReporter(desmoj.core.simulator.Reportable informationSource) {
