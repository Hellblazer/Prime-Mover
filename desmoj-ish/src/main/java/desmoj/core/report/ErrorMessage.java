 ...
 * In contrast to <code>Exceptions</code> and fatal errors, an ErrorMessage does
 * not stop the simulation run or exit the Java runtime.
 *
...
public class ErrorMessage extends Message {
    ...
    /*
     * Describes in a few sentences how the warning can be prevented in the future.
     */
    private String _errPrevention;

    /*
     * The reason that caused the operation to fail. It is a description of the
     * circumstances leading to the warning. Use not more than one short sentence.
     */
     ...
     * @param errorLocation    java.lang.String : Class and method the error occured
     *                         in
     ...
     */
    // TODO:
    public ErrorMessage(Model origin, String errorDescription, String errorLocation, String errorReason,
                        String errorPrevention, TimeInstant errorTime) {
    ...
    /**
     * Returns a String giving a hint on how to prevent this error to happen. Note
     * that the hint given is based on the probable reason described but must not
     * always have that reason.
     *
     ...
     * Note that the reason given here is the most probable reason for the effect to
     * occur here. It might have its origin in other classes, so bear in mind that
     * the casue for the error might have been created in a class not obviously
     * related to the location this error occured.
     *
     * @return java.lang.String : The probable reason for this error
     */
