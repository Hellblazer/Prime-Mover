...
public class ContDistErlangReporter extends DistributionReporter {
     ...
     *                          ContDistErlang distribution to report about
     */
    public ContDistErlangReporter(desmoj.core.simulator.Reportable informationSource) {
     ...
     *         about the ContDistErlang distribution
     */
    @Override
