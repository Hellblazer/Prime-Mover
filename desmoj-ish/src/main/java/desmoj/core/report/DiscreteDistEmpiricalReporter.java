...
public class DiscreteDistEmpiricalReporter extends DistributionReporter {
     ...
     *                          EmpiricalDiscreteDist distribution to report about
     */
    public DiscreteDistEmpiricalReporter(desmoj.core.simulator.Reportable informationSource) {
     ...
     *         about the EmpiricalDiscreteDist distribution
     */
    @Override
