...
public class ContDistNormalReporter extends DistributionReporter {
     ...
     *                          ContDistNormal distribution to report about
     */
    public ContDistNormalReporter(desmoj.core.simulator.Reportable informationSource) {
     ...
     *         about the ContDistNormal distribution
     */
    @Override
