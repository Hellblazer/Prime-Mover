...
public class BoolStatisticReporter extends desmoj.core.report.Reporter {
    ...
    /**
     * Constructor for a new BoolStatisticReporter. Note that although any
     * Reportable is accepted you should make sure that only subtypes of
     * BoolStatistic are passed to this constructor. Otherwise the number of column
     * titles and their individual headings will differ from the actual content
     * collected by this reporter.
     *
     * @param informationSource desmoj.core.simulator.Reportable : The BoolStatistic
     *                          to report about.
     */
