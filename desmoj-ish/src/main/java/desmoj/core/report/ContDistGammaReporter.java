...
public class ContDistGammaReporter extends DistributionReporter {
     ...
     *
     * @param informationSource desmoj.core.simulator.Reportable : The GammaDist
     *                          distribution to report about
     */
    public ContDistGammaReporter(desmoj.core.simulator.Reportable informationSource) {
     ...
     *         about the ContDistGamma distribution
     */
    @Override
