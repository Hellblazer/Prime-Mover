...
/**
 * A table formatter class for writing simulation output to HTML tables. It also
 * supports the visualisation of 2D-charts based on HTML5's canvas-element. This
...
public class HTMLTableChartFormatter extends AbstractTableFormatter {
    ...
    /**
     * Inserts a reference to the top page and close the HTML file by writing the
     * footing tags, flushing the buffer and closing the file.
     */
    @Override
    public void close() {
     ...
     *
     * @param cellColor java.awt.Color : The color of the cell, that should be
     *                  created.
     */
    ...
    public void writeHeading(int style, String s) {
        ...
        // now write heading
        out.write("<p></p><h" + style + "><div align=\"center\">" + s + "</div></h" + style + "><p></p>");
    ...
    /**
     * Inserts a reference to the top page and writes the HTML tag for inserting a
     * horizontal ruler into the file. Note that horizontal rulers are not written
    ...
    private void createCanvas(String canvasID, int canvasWidth, int canvasHeight) {
        ...
        out.writeln("<canvas id=\"" + canvasID + "\" width=\"" + canvasWidth + "\" height=\"" + canvasHeight + "\">");
