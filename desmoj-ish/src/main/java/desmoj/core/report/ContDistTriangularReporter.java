...
public class ContDistTriangularReporter extends DistributionReporter {
     ...
     *                          TriangularDist distribution to report about
     */
    public ContDistTriangularReporter(desmoj.core.simulator.Reportable informationSource) {
     ...
     *         about the ContDistTriangular distribution
     */
    @Override
