...
public class ContDistCustomReporter extends DistributionReporter {
     ...
     *                          CustomContDist distribution to report about
     */
    public ContDistCustomReporter(desmoj.core.simulator.Reportable informationSource) {
     ...
     *         about the ContDistCustom distribution
     */
    @Override
