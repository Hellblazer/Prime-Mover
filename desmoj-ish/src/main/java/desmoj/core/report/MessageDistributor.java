 ...
 * same type of messages as well as a <code>MessageReceiver</code> can be registered with different types of messages,
 * if it is capable of handling such. This enables a modeller i.e. to get the error messages displayed on screen
 * additional to the file being stored on harddisk by default. This is also handy if a simulation should be run as an
 * Applet thus having no or restricted disk access and using multiple scrollable windows instead.
 *
 * @author Tim Lechler
 *
...
public class MessageDistributor implements MessageReceiver {
    ...
    public MessageDistributor() {
        ...
        try {
            ...
            new ErrorMessage(null, "Can't find class \"desmoj.core.report.Reporter\"!",
                             "MessageDistributor-Contructor.",
                             "The classfile is probably missing or does not reside in the" + "folder /desmoj/report.",
                             "Make sure to have the DESMOJ framework installed correctly", null)));
        }
