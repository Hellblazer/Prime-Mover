...
public class DistributionReporter extends Reporter {
     ...
     */
    public DistributionReporter(desmoj.core.simulator.Reportable informationSource) {
    ...
    public java.lang.String[] getEntries() {
        ...
        if (source instanceof desmoj.core.dist.Distribution) {
            ...
            entries[6] = " ";
            // seed
            entries[7] = Long.toString(((desmoj.core.dist.Distribution) source).getInitialSeed());
