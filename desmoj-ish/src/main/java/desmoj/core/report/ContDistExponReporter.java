...
/**
 * Reports all information about a ContDistExponential (or ContDistweibull)
 * distribution.
 *
...
public class ContDistExponReporter extends DistributionReporter {
     ...
     *                          ContDistExponential distribution to report about
     */
    public ContDistExponReporter(desmoj.core.simulator.Reportable informationSource) {
     ...
     *         about the ContDistExponential distribution
     */
    @Override
