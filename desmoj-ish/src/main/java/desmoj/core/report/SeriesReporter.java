    ...
    public java.lang.String[] getEntries() {
        ...
        if (source instanceof Series<?>) {
            ...
            if (source instanceof SeriesEntities<?>) {
                ...
                // param1
                entries[4] = Double.toString(desmoj.core.statistic.StatisticObject.round(((SeriesNumerical<?>) series).getMean()));
                // param2
                entries[5] = Double.toString(desmoj.core.statistic.StatisticObject.round(((SeriesNumerical<?>) series).getStdDev()));
            } else {
                // Type
