 ...
 * parameters. This pattern can be found in several frameworks for agent- or
 * component-based simulation (e.g. 'Probes' in Swarm - see www.swarm.org). The
 * term 'access point' was adopted from the dissertation "Ein flexibler,
