 ...
 * capacity limit can be determined by the user. <code>Bin</code> is derived from
...
public class Bin extends desmoj.core.simulator.QueueBased {
     ...
     * in the queue. Is <code>false</code> per default.
     */
    ...
    public Bin(desmoj.core.simulator.Model owner, String name, int sortOrder, int qCapacity, long initialUnits,
        ...
        {
            sendWarning(
            "Attempt to construct a Bin with a negativ number of" + " units. Initial number of units set to zero!",
    ...
    public double avgAvail() {
        ...
        {
            sendWarning(
            "A Division-by-Zero error occured in a calculation. " + "The UNDEFINED Value: -1.0 is returned as result.",
            "Bin: " + getName() + " Method: double avgAvail ()", "The Time difference is shorter than epsilon.",
    ...
    public boolean retrieve(long n) {
        ...
        {
            sendWarning(
            "Attempt to take nothing or a negative number of units" + " out of a Bin. The attempted action is ignored!",
            "Bin: " + getName() + " Method: " + _where, "It does not make sense to take nothing or less out of a Bin. "
    ...
    public void store(long n) {
        ...
        {
            sendWarning(
            "Attempt to store nothing or a negative number of units" + " in a Bin. The attempted action is ignored!",
    ...
    protected boolean checkProcess(SimProcess p, String where) {
        ...
        if (!isModelCompatible(p)) // if p is not modelcompatible
        {
            sendWarning("The process trying to use a Bin object does not "
                        ...
                        "Bin: " + getName() + " Method: " + where, "The process is not modelcompatible.",
     ...
     *
     * @param n long : Is positive when producers <code>store()</code> new products in the bin and negative when the Bin
