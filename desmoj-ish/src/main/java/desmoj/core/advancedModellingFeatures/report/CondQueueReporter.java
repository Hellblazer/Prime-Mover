...
public class CondQueueReporter extends desmoj.core.report.Reporter {
    ...
    /**
     * Constructor for a new CondQueueReporter. Note that although any Reportable is
     * accepted you should make sure that only subtypes of CondQueue are passed to
     ...
     *
     * @param informationSource desmoj.core.simulator.Reportable : The CondQueue to
     *                          report about
     */
