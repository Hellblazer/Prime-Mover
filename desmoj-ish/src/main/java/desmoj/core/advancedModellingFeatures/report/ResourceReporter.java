...
public class ResourceReporter extends desmoj.core.report.Reporter {
    ...
    /**
     * Constructor for a new ResourceReporter. Note that although any Reportable is
     * accepted you should make sure that only subtypes of Res are passed to this
     ...
     *
     * @param informationSource desmoj.core.simulator.Reportable : The Res to report
     *                          about.
     */
