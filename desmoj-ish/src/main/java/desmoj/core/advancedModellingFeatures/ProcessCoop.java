...
public abstract class ProcessCoop<M extends SimProcess, S extends SimProcess>
     ...
     */
    public ProcessCoop(desmoj.core.simulator.Model owner, String name, boolean showInTrace) {
    ...
    protected void activate(TimeSpan dt) {
        ...
        if (currentProcess == null) {
            sendWarning("The current process of a cooperation is not found. " + "The attempted action is ignored!",
                        "ProcessCoop: " + getName() + " Method: activate()",
    ...
    protected void activateAfter(Schedulable after) {
        ...
        if (currentProcess == null) {
            sendWarning("The current process of a cooperation is not found. " + "The attempted action is ignored!",
                        "ProcessCoop: " + getName() + " Method: activateAfter()",
                        "The current process is only a null pointer.",
                        "Make sure that only real SimProcesses are cooperating.");
            return;
        }
    ...
    protected void activateBefore(Schedulable before) {
        ...
        if (currentProcess == null) {
            sendWarning("The current process of a cooperation is not found. " + "The attempted action is ignored!",
                        "ProcessCoop: " + getName() + " Method: activateBefore()",
                        "The current process is only a null pointer.",
                        "Make sure that only real SimProcesses are cooperating.");
            return;
        }
    ...
    protected int getPriority() {
        ...
        if (currentProcess == null) {
            sendWarning("The current process of a cooperation is not found. " + "Zero is returned as priority!",
                        "ProcessCoop: " + getName() + " Method: getPriority()",
                        "The current process is only a null pointer.",
                        "Make sure that only real SimProcesses are cooperating.");
            return 0;
        }
    ...
    protected void hold(TimeSpan dt) {
        ...
        if (currentProcess == null) {
            sendWarning("The current process of a cooperation is not found. " + "The attempted action is ignored!",
                        "ProcessCoop: " + getName() + " Method: hold()", "The current process is only a null pointer.",
                        "Make sure that only real SimProcesses are cooperating.");
            return;
        }
    ...
    protected void passivate() {
        ...
        if (currentProcess == null) {
            sendWarning("The current process of a cooperation is not found. " + "The attempted action is ignored!",
                        "ProcessCoop: " + getName() + " Method: passivate()",
                        "The current process is only a null pointer.",
                        "Make sure that only real SimProcesses are cooperating.");
            return;
        }
    ...
    protected void reActivate(TimeSpan dt) {
        ...
        if (currentProcess == null) {
            sendWarning("The current process of a cooperation is not found. " + "The attempted action is ignored!",
                        "ProcessCoop: " + getName() + " Method: reActivate()",
                        "The current process is only a null pointer.",
                        "Make sure that only real SimProcesses are cooperating.");
            return;
        }
    ...
    protected void setPriority(int newPriority) {
        ...
        if (currentProcess == null) {
            sendWarning("The current process of a cooperation is not found. " + "The attempted action is ignored!",
                        "ProcessCoop: " + getName() + " Method: setPriority()",
                        "The current process is only a null pointer.",
                        "Make sure that only real SimProcesses are cooperating.");
            return;
        }
