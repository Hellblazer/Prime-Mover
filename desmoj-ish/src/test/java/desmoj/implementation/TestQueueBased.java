...
/**
 * TestImplementation for the Class QueueBased. To be able to initiate a Queue for testing.
 *
 * @author Clara Bluemm
...
public class TestQueueBased extends QueueBased {
     ...
     */
    public TestQueueBased(Model owner, String name, boolean showInReport, boolean showInTrace) {
    ...
    /**
     * Also the method "deleteItem" is declared as "protected". For testing reasons this method is created.
     *
    ...
    /**
     * Method to insert an Item into the Queue. Since these operation is specified in the underlying classes and the
     * method updateStatistics() is declared "protected", this method should provide an opportunity to test the
     * statistics.
     *
     * @param i int: amount of elements to be inserted
     */
