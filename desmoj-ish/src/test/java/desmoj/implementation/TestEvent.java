...
/**
 * This class is derived from the abstract class Event. It has to override only one method, which describes the Routine,
 * which changes the inner state of the entity.
 *
 * @author Clara Bluemm
...
public class TestEvent extends Event {
    ...
    /**
     * The Routine to change the inner state of the given Entity. It adds 1 to the variable count.
     *
