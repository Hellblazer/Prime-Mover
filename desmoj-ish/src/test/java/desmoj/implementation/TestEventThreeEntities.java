...
/**
 * This class is implemented for testing the class EventNote. It implements the super class EventThreeEntities
 *
 * @author Clara Bluemm
...
public class TestEventThreeEntities extends EventOf3Entities {
    ...
    /**
     * The routine which changes the inner state of all three of the given Entities. It adds 3 to the variable count of
     * all TestEntities.
     *
     * @see desmoj.core.simulator.EventThreeEntities#eventRoutine(desmoj.core.simulator.Entity,
     * desmoj.core.simulator.Entity, desmoj.core.simulator.Entity)
     */
    @Override
