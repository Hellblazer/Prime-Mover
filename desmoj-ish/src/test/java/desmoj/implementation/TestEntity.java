...
/**
 * This TestEntity is generated to have the ability to test all Classes, which need an entity to operate on.
 *
 * @author Clara Bluemm
 * @see eventList
 * @see EventNote
...
public class TestEntity extends Entity {
    ...
    /**
     * To have the option to change the Entities inner state this method changes the variable count.
     *
    ...
    /**
     * To validate the inner change of the entity, this method can be used
     *
