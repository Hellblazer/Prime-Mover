...
/**
 * This class is implemented for testing the class EventNote. It implements the super class EventTwoEntities
 *
...
public class TestEventTwoEntities extends EventOf2Entities {
    ...
    /**
     * The routine which changes the inner state of every given entity. Here it adds 2 two the variable count of the
     * entity.
     *
     * @see desmoj.core.simulator.EventTwoEntities#eventRoutine(desmoj.core.simulator.Entity,
