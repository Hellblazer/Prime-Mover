...
/**
 * In this class we test the class QueueList. This class has just two methods but declares many as abstract. These get
 * implementd in QueueListStandard. Mind the derived methods from the classes named below. All these are part of the
 * package desmoj.core.simulator.
 *
...
public abstract class QueueListModulTest extends QueueBasedModulTest {
    ...
    /**
     * Returns the <code>QueueBased</code> object the <code>QueueList</code> serves as a queue implementation for.
     */
