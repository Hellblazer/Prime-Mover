 ...
 */
public class SimulationTransformClassFileAPI implements Closeable {
    ...
    /**
     * Creates a new SimulationTransformClassFileAPI with the given ClassGraph configuration.
     * 
     * @param graph ClassGraph instance configured for the desired packages
     */
    public SimulationTransformClassFileAPI(ClassGraph graph) {
    ...
    /**
     * Creates a new SimulationTransformClassFileAPI with an existing scan result.
     * 
    ...
    /**
     * Creates an EntityGeneratorClassFileAPI for the specified class name.
     * 
     * @param classname Fully qualified class name of the entity
     * @return EntityGeneratorClassFileAPI instance or null if class not found
     */
    public EntityGeneratorClassFileAPI generatorOf(String classname) {
        return generatorOf(classname, ACCEPT_ALL_FILTER);
    }

    /**
     * Creates an EntityGeneratorClassFileAPI for the specified class name with filtering.
     * 
     * @param classname Fully qualified class name of the entity
     * @param selector Filter to apply to entity classes
     * @return EntityGeneratorClassFileAPI instance or null if class not found
     */
    public EntityGeneratorClassFileAPI generatorOf(String classname, ClassInfoFilter selector) {
    ...
    /**
     * Creates EntityGeneratorClassFileAPI instances for all entity classes.
     * 
     * @return Map of ClassInfo to EntityGeneratorClassFileAPI for all entities
     */
    public Map<ClassInfo, EntityGeneratorClassFileAPI> generators() {
        return generators(ACCEPT_ALL_FILTER);
    }

    /**
     * Creates EntityGeneratorClassFileAPI instances for filtered entity classes.
     * 
     * @param selector Filter to apply to entity classes
     * @return Map of ClassInfo to EntityGeneratorClassFileAPI for filtered entities
     */
    public Map<ClassInfo, EntityGeneratorClassFileAPI> generators(ClassInfoFilter selector) {
        var entities = findEntityClasses(selector);
        return generators(entities);
    }

    /**
     * Creates EntityGeneratorClassFileAPI instances for the provided entity class list.
     * 
     * @param entities List of entity ClassInfo objects
     * @return Map of ClassInfo to EntityGeneratorClassFileAPI
     */
    public Map<ClassInfo, EntityGeneratorClassFileAPI> generators(ClassInfoList entities) {
    ...
    /**
     * Creates an EntityGeneratorClassFileAPI for the given entity class by analyzing its
     * event methods and interfaces.
     * 
     * @param entityClass The entity class to create a generator for
     * @return EntityGeneratorClassFileAPI instance for the class
     */
    private EntityGeneratorClassFileAPI createEntityGenerator(ClassInfo entityClass) {
        ...
        try {
            return new EntityGeneratorClassFileAPI(entityClass, eventMethods, transformTimestamp);
        } catch (Exception e) {
            throw new IllegalStateException("Failed to create EntityGeneratorClassFileAPI for " + entityClass.getName(), e);
        }
    }
    ...
    /**
     * Transforms entity classes using EntityGeneratorClassFileAPI and API remapping.
     * 
