...
public class EntityGenerator {
    ...
    private void boxPrimitive(CodeBuilder codeBuilder, char primitiveType) {
        switch (primitiveType) {
            case 'I' -> codeBuilder.invokestatic(ClassDesc.of("java.lang.Integer"), "valueOf",
                                                 MethodTypeDesc.of(ClassDesc.of("java.lang.Integer"),
                                                                   ConstantDescs.CD_int));
            case 'J' -> codeBuilder.invokestatic(ClassDesc.of("java.lang.Long"), "valueOf",
                                                 MethodTypeDesc.of(ClassDesc.of("java.lang.Long"),
                                                                   ConstantDescs.CD_long));
            case 'F' -> codeBuilder.invokestatic(ClassDesc.of("java.lang.Float"), "valueOf",
                                                 MethodTypeDesc.of(ClassDesc.of("java.lang.Float"),
                                                                   ConstantDescs.CD_float));
            case 'D' -> codeBuilder.invokestatic(ClassDesc.of("java.lang.Double"), "valueOf",
                                                 MethodTypeDesc.of(ClassDesc.of("java.lang.Double"),
                                                                   ConstantDescs.CD_double));
            case 'Z' -> codeBuilder.invokestatic(ClassDesc.of("java.lang.Boolean"), "valueOf",
                                                 MethodTypeDesc.of(ClassDesc.of("java.lang.Boolean"),
                                                                   ConstantDescs.CD_boolean));
            case 'B' -> codeBuilder.invokestatic(ClassDesc.of("java.lang.Byte"), "valueOf",
                                                 MethodTypeDesc.of(ClassDesc.of("java.lang.Byte"),
                                                                   ConstantDescs.CD_byte));
            case 'C' -> codeBuilder.invokestatic(ClassDesc.of("java.lang.Character"), "valueOf",
                                                 MethodTypeDesc.of(ClassDesc.of("java.lang.Character"),
                                                                   ConstantDescs.CD_char));
            case 'S' -> codeBuilder.invokestatic(ClassDesc.of("java.lang.Short"), "valueOf",
                                                 MethodTypeDesc.of(ClassDesc.of("java.lang.Short"),
    ...
    private void buildTransformedClass(ClassBuilder classBuilder, ClassModel originalClass) {
        ...
        var originalInterfaces = clazz.getInterfaces().stream().map(ci -> ClassDesc.of(ci.getName())).toArray(
        ClassDesc[]::new);
        ...
        Annotation.of(TRANSFORMED_CLASS, AnnotationElement.of("timestamp", AnnotationValue.ofString(timestamp)))));
    ...
    private MethodInfo findMethodInfo(MethodModel methodModel) {
        ...
        return allEventMethods.stream().filter(
        mi -> mi.getName().equals(name) && mi.getTypeDescriptorStr().equals(descriptor)).findFirst().orElse(null);
    }
    ...
    private boolean hasInvokeMethod(ClassModel originalClass) {
        return originalClass.methods().stream().anyMatch(
        method -> method.methodName().stringValue().equals("__invoke"));
    }
    ...
    private boolean hasSignatureForMethod(ClassModel originalClass) {
        return originalClass.methods().stream().anyMatch(
        method -> method.methodName().stringValue().equals("__signatureFor"));
    }
    ...
    private boolean isWrapperClass(String className) {
        return className.equals("java.lang.Integer") || className.equals("java.lang.Long") || className.equals(
        "java.lang.Float") || className.equals("java.lang.Double") || className.equals("java.lang.Boolean")
        || className.equals("java.lang.Byte") || className.equals("java.lang.Character") || className.equals(
        "java.lang.Short");
    }
