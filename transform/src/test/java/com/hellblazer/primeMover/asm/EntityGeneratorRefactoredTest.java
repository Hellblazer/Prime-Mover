...
public class EntityGeneratorRefactoredTest {
    ...
    public void testRefactoredGeneratorCompiles() throws Exception {
        ...
        EntityGenerator originalGenerator = transform.generatorOf(name);
        ...
        try (var scanResult = new ClassGraph().acceptPackages("com.hellblazer.primeMover.asm.testClasses")
            ...
            var classInfo = scanResult.getClassesWithAnnotation("com.hellblazer.primeMover.annotations.Entity")
                                     .get(name);
            assertNotNull(classInfo);
            
            var events = classInfo.getDeclaredMethodInfo()
                                 .stream()
    ...
    public void testRefactoredGeneratorFunctionality() throws Exception {
        try (var scanResult = new ClassGraph().acceptPackages("com.hellblazer.primeMover.asm.testClasses")
            ...
            System.out.println("Implements EntityReference: " + 
                com.hellblazer.primeMover.runtime.EntityReference.class.isAssignableFrom(clazz));
        }
    }
}