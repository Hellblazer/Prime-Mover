...
/**
 * Test to verify that the ClassFile API implementation generates identical
 * bytecode to the original ASM implementation.
 */
public class BytecodeComparisonTest {
    ...
    public void testClassLoading() throws Exception {
        ...
        Class<?> asmClass = asmLoader.defineClass("com.chiralbehaviors.janus.testClasses.Composite1$composite", asmBytecode);
        ...
        Class<?> classFileClass = classFileLoader.defineClass("com.chiralbehaviors.janus.testClasses.Composite1$composite", classFileBytecode);
        ...
        for (var field : asmFields) {
            if ("mixIn_0".equals(field.getName())) asmHasMixIn0 = true;
            if ("mixIn_1".equals(field.getName())) asmHasMixIn1 = true;
        }
        for (var field : classFileFields) {
            if ("mixIn_0".equals(field.getName())) cfHasMixIn0 = true;
            if ("mixIn_1".equals(field.getName())) cfHasMixIn1 = true;
        }
