...
public class EventImpl implements Cloneable, Serializable, Comparable<EventImpl>, Event {
     ...
     *
     * <p><b>Why needed:</b> EventImpl is Serializable to support persistence and distributed simulation.
     * This UID ensures serialized EventImpl objects can be deserialized across different versions.
     *
     * <p><b>How derived:</b> Generated by Java serialization mechanism based on the initial class structure.
     * The negative value indicates it was system-generated, not manually assigned.
     *
     * <p><b>Versioning implications:</b> Changing EventImpl's field structure (add/remove/rename fields)
     * creates serialization incompatibility. Old serialized events won't deserialize into new class structure
     * unless serialVersionUID is updated AND custom readObject/writeObject methods handle migration.
     *
     * <p><b>If you must change:</b>
     * <ul>
     *   <li>Adding fields: Keep same UID, add default values in new fields</li>
     *   <li>Removing fields: Increment UID, old serialized data becomes incompatible</li>
     *   <li>Type changes: Increment UID, implement custom serialization migration</li>
     *   <li>Breaking changes: Use semantic versioning - increment framework version</li>
     * </ul>
     *
     * <p><b>Current policy:</b> Any field structure change that breaks serialization compatibility
     * requires a minor version bump (e.g., 1.0.x -> 1.1.0) and release notes warning.
     */
